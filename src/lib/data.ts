...
export const sprints: Sprint[] = [
  {
    ...
    runCapacity: 67.2,
    tickets: [
      { id: 'WIN-5929', title: 'Implement new login flow', scope: 'Web', type: 'User story', typeScope: 'Build', estimation: 8, timeLogged: 8, status: 'Done', completionDate: '2024-07-09' },
      { id: 'WIN-5930', title: 'Fix API authentication issue', scope: 'Backend', type: 'Bug', typeScope: 'Run', estimation: 5, timeLogged: 6, status: 'Done', completionDate: '2024-07-10' },
      { id: 'WIN-5931', title: 'Update home screen UI', scope: 'iOS', type: 'User story', typeScope: 'Build', estimation: 13, timeLogged: 13, status: 'Done', completionDate: '2024-07-11' },
      { id: 'WIN-5932', title: 'Add push notification support', scope: 'Android', type: 'User story', typeScope: 'Build', estimation: 8, timeLogged: 8, status: 'Done', completionDate: '2024-07-12' },
      ...
      { id: 'WIN-5938', title: 'Add new endpoint for user data', scope: 'Backend', type: 'User story', typeScope: 'Build', estimation: 8, timeLogged: 8, status: 'Done', completionDate: '2024-07-15' },
      { id: 'WIN-5939', title: 'Optimize image loading on Android', scope: 'Android', type: 'Task', typeScope: 'Run', estimation: 5, timeLogged: 5, status: 'Done', completionDate: '2024-07-15' },
      { id: 'WIN-5940', title: 'Fix CSS bug on marketing page', scope: 'Web', type: 'Bug', typeScope: 'Run', estimation: 3, timeLogged: 3, status: 'Done', completionDate: '2024-07-15' },
    ],
    burnDownData: [] // This will be calculated dynamically now
  },
  {
    id: 'sprint-2',
