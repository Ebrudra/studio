...
export const sprints: Sprint[] = [
  {
    ...
    tickets: [
      ...
      { id: 'WIN-5930', title: 'Fix API authentication issue', description: 'Users are unable to log in due to a token validation error in the main API.', platform: 'Backend', assignee: assigneeConfig.Backend, type: 'Bug', typeScope: 'Run', estimation: 5, timeLogged: 6, status: 'Done', tags: ['bug', 'security'], completionDate: '2024-07-10T10:00:00.000Z', dailyLogs: [{ date: '2024-07-10', loggedHours: 6 }] },
      { id: 'WIN-5931', title: 'Update home screen UI', description: 'Redesign the home screen to include new promotional banners and a carousel.', platform: 'iOS', assignee: assigneeConfig.iOS, type: 'User story', typeScope: 'Build', estimation: 13, timeLogged: 13, status: 'Done', tags: ['ui', 'ux'], completionDate: '2024-07-11T10:00:00.000Z', dailyLogs: [{ date: '2024-07-11', loggedHours: 13 }] },
  ...
  },
  {
    ...
    tickets: [
      ...
      { id: 'WIN-6002', title: 'Database migration script', description: 'Write and test a script to migrate legacy data to the new database schema.', platform: 'Backend', assignee: assigneeConfig.Backend, type: 'Task', typeScope: 'Build', estimation: 21, timeLogged: 0, status: 'To Do', tags: ['database', 'migration'], dailyLogs: [] },
      { id: 'WIN-6003', title: 'iOS 18 compatibility fixes', description: 'Address UI bugs and crashes reported on the iOS 18 beta.', platform: 'iOS', assignee: assigneeConfig.iOS, type: 'Task', typeScope: 'Run', estimation: 8, timeLogged: 0, status: 'To Do', tags: ['ios', 'compatibility'], dailyLogs: [] },
      { id: 'WIN-6004', title: 'Improve Android app startup time', description: 'Profile and optimize the app startup sequence to improve performance.', platform: 'Android', assignee: assigneeConfig.Android, type: 'Task', typeScope: 'Run', estimation: 5, timeLogged: 0, status: 'To Do', tags: ['performance', 'android'], dailyLogs: [] },
    ],
  },
];
