...
export function TeamCapacityTable({ sprint }: TeamCapacityTableProps) {
  const capacityData = useMemo(() => {
    const teamsInSprint = Object.keys(sprint.teamCapacity || {}).filter(t => t !== 'Out of Scope') as Team[];
  ...
  return (
     <div className="space-y-6">
        ...
        <Card>
            ...
            <p className="text-sm text-muted-foreground">Individual team performance and capacity utilization</p>
            </CardHeader>
            <CardContent>
